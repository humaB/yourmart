...
<script>
  import GateProductInwardPopup from "../../components/gate/GateProductInwardPopup.vue";
    import TableHeader from "../../components/table/TableHeaderComponent.vue";

  import moment from "moment";
    export default {
        name : 'GatePendingPurchaseOrderPage',
        components: {
            TableHeader,
            GateProductInwardPopup
        },
        ...
        methods : {
            ...
            fetchPurchaseOrders(){
                let vm = this;
                axios
                .get(this.api_url + "inventory/products/gate/pending-purchase-orders")
                .then((response) => {
            ...
            generatePass(data){
                ...
                vm.btnLoader = true;
                axios
                .post(this.api_url + "inventory/products/gate/product-inward", data)
                .then((response) => {
                    vm.btnLoader = false;
                    this.fetchPurchaseOrders();
                    return swal({
                        title: "Success",
                        text: 'Gate In ward Created Successfully',
                        icon: "success",
                        timer: 3000,
                    });
                })
