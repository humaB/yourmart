            ...
            <div class="col-12 col-sm-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Inventory Good Returns Register</h5>
                    </div>
                    <div class="card-body row">
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-bordered" id="inventory_good_returns" v-else>
                                <thead>
...
export default {
    ...
    methods: {
        ...
        submitFunction() {
            this.clearDataTable()
            this.$emit('inventoryGoodReturnFilter', this.filter);
        },
        clearDataTable() {
            const table = $('#inventory_good_returns').DataTable();
            table.destroy();
        },
    },
    watch: {
        data(newLedger) {
            setTimeout(() => {
                $('#inventory_good_returns').DataTable({
                    "bSort": false,
                    dom: 'Bfrtip',
                    buttons: [
                        {
                            extend: 'copy',
                            title: 'Inventory Good Return',
                        }, 'csv', {
                            extend: 'excel',
                            title: 'Inventory Good Return',
                        }
