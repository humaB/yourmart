                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <v-select :options="cashes" v-model="editData.account_head_id" :reduce="option => option.code">
                            </v-select>
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="border p-2 mb-2">
                        ...
                        <div class="row" v-for="(i, index) in transactionLoop" :key="index">
                            <div class="form-group mb-2 col-md-4">
                                <v-select :options="heads" v-model="editData.ledgers[index]" :reduce="option => option.code" @input="saveTransactionRow($event, 'first', index)">
                                </v-select>
                            </div>
...
<script>
export default {
  props: ['btnLoading', 'editData', 'cashes', 'heads'],
  data() {
    return {
        finalData: {
            total_amount : 0,
  ...
  created(){
    ...
    methods: {
        ...
        saveTransactionRow(event, fieldName, index) {
            if (fieldName == "first") {
                this.editData.ledgers[index] = event;
            }
            if (fieldName == "second") {
