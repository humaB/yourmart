<template>
    <div>
        <!-- Modal -->
        <div class="modal fade" id="addShippingClass" tabindex="-1" role="dialog"
            aria-labelledby="addShippingClassTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Add Shipping Class</h5>
