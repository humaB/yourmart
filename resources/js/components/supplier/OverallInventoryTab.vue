<template>
    <div>
                        ...
                        <div class="padding-20">
                            <div class="text-right">
                                <h3 class="font-light mb-0">
                                    <i class="ti-arrow-up text-success"></i> {{ formatPrice(overallStats.totalStockValue) }}
                                </h3>
                ...
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="padding-20">
                            <div class="text-right">
                                <h3 class="font-light mb-0">
                                    <i class="ti-arrow-up text-success"></i> {{ formatPrice(overallStats.totalSoldOutValue) }}
                                </h3>
                ...
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="padding-20">
                            <div class="text-right">
                                <h3 class="font-light mb-0">
                                    <i class="ti-arrow-up text-success"></i> {{ formatPrice(overallStats.totalPaid) }}
                                </h3>
                ...
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="padding-20">
                            <div class="text-right">
                                <h3 class="font-light mb-0">
                                    <i class="ti-arrow-up text-success"></i> {{ formatPrice(overallStats.balance) }}
                                </h3>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <table class="table table-bordered text-center align-middle w-100" id="dataTable3">
                    <thead>
                        <tr>
                            <th rowspan="2">#</th>
                    ...
                    <tbody>
                        <!-- Example empty rows -->
                        <tr v-for="(row, index) in overallStats.products" :key="index">
                            <td>{{ index + 1 }}</td>
                            ...
                            <td>
                                <button class="btn btn-primary" @click="fetchPurchaseOrders(row.slug, 'overall')" data-toggle="modal"
...
<script>
export default {
    name: "OverallInventoryTab",
    props : [ 'overallStats', 'filter', 'suppliers'],
    methods : {
        formatPrice(price) {
